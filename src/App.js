...
// const RELAYER_URL = process.env.REACT_APP_OPENZEPPELIN_WEBHOOK_URI;
// const CONTRACT_ADDRESS = process.env.REACT_APP_POLYGON_NFT_CONTRACT_ADDRESS;
...
//       // Check if the user already has an NFT here
...
//     if (hasNFT) {
//       alert("You already have an NFT, not able to mint anymore.");
//       return;
//     }
//     setLoading(true);
//     setError(null);
...
//       // Call the minting function (replace "mint" with your function's name and add any necessary arguments)
...
//           <button onClick={handleMint} disabled={loading || hasNFT} className='bg-blue-600 text-white px-4 py-2 rounded'>
//             Mint NFT
//           </button>
//         </>
//       )}
//       {hasNFT && <p>You already have an NFT, not able to mint anymore.</p>}
//       {loading && <p>Minting...</p>}
//       {error && <p style={{ color: 'red' }}>{error}</p>}
//       {success && <p style={{ color: 'green' }}>NFT Minted Successfully!</p>}
//     </div>
//   );
// };
...
//       const contractInstance = await sdk.getContract("0x7af19225043eBBc1D7F373aD5eC6FC00E8E823b4");
...
//   return (
//     <ThirdwebSDKProvider
//       desiredChainId={ChainId.Polygon} // For Polygon
//       signer={signer}
//       sdkOptions={{
//         gasless: {
//           openzeppelin: {
